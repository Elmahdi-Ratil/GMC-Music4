...
client.on('ready', function() {
    ...
    client.user.setGame(prefix + 'GMC™ || 4help');
});
...
client.on('message', message => {
  ...
  if (message.author.id !== "548406731223597078") return;
...
if (message.content.startsWith(PREFIX + 'setavatar')) {
  client.user.setAvatar(argresult, "https://discordapp.com/api/oauth2/authorize?client_id=548406731223597078&permissions=8&scope=bot");
